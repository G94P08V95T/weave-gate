...
<h1 class="sws-title" align="center">WeaveGate</h1>

<h4 align="center">
    A cross-platform frontend gateway: static files, reverse proxy, and round-robin load balancing
  </h4>
...
**WeaveGate** is a tiny and fast production-ready frontend gateway for static web files, reverse proxy, and round-robin upstream load balancing.
