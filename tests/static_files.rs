...
mod tests {
    ...
    use weavegate::http_ext::MethodExt;
    use std::fs;
    ...
    use weavegate::compression;

    #[cfg(feature = "directory-listing")]
    use weavegate::directory_listing::DirListFmt;
    use weavegate::static_files::{self, HandleOpts};
            ...
            .await
            {
                Ok(result) => {
                    ...
                    let res = compression::auto(
                        method,
                        &headers,
                        weavegate::settings::CompressionLevel::Default,
                        res,
                    )
