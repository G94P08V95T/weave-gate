...
pub struct General {
    ...
    /// weavegate, before arranging for the resulting file descriptor to be inherited by
    /// weavegate. Cannot be used in conjunction with the port and host arguments. The
    /// included systemd unit file utilises this feature to increase security by allowing the
    /// weavegate to be sandboxed more completely.
    pub fd: Option<usize>,
